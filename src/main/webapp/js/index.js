...
function init() {
    for (let i = 0; i < viewChoserList.length; i++) {
        viewChoserList[i].style.left = String(350*i-200) + 'px';
...
function btnHover(index) {
    ...
    viewChoserList[index].style.width = '350px';
    viewChoserList[index].style.height = '650px';
    viewChoserList[index].style.left = String(350*index-200-10) + 'px';
...
function btnLeave(index) {
    ...
    viewChoserList[index].style.width = '330px';
    viewChoserList[index].style.height = '600px';
    viewChoserList[index].style.left = String(350*index-200) + 'px';
